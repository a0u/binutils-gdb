/* Target-dependent header for RISC-V.
...
enum {
  ...
  RISCV_TP_REGNUM             = 3,    /* Thread pointer */
  RISCV_GP_REGNUM             = 4,    /* Global pointer */
  RISCV_FP_REGNUM             = 8,    /* Frame pointer */
  RISCV_A0_REGNUM             = 10,   /* Argument/return value */
  RISCV_A1_REGNUM             = 11,   /* Argument/return Value */
  RISCV_PC_REGNUM             = 32,   /* Program Counter */
  RISCV_FIRST_FP_REGNUM       = 33,   /* First Floating Point Register */
  RISCV_FA0_REGNUM            = 43,
  RISCV_FA1_REGNUM            = 44,
  RISCV_LAST_FP_REGNUM        = 64,   /* Last Floating Point Register */
  RISCV_FFLAGS_REGNUM         = 65,
  RISCV_FRM_REGNUM,
  RISCV_FCSR_REGNUM,
  RISCV_STATS_REGNUM,
  RISCV_SUP0_REGNUM,
